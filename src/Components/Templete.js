...
const Templete = ({title, desc1, desc2, image, formtype, setIsLoggedIn}) => {
  return (
    <div className='flex justify-between w-11/12 max-w-[1160px] pt-[0rem] pb-[3rem] mx-auto gap-x-12 gap-y-0 '>
        ...
        <div className='flex w-full items-center my-8 gap-x-2 '>
            <div className='w-full h-[1px] bg-richblack-700'></div>
            <p className='text-richblack-700 font-medium loading[1.375rem]'>OR</p>
            <div className='w-full h-[1px] bg-richblack-700'></div>
        </div>
